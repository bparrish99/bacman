    ...
    local ghosts = {
         {
            name = "Blinky",
            color = { 1, 0, 0 },
            x = 15 * PIXELS_PER_TILE,
            y = 15.5 * PIXELS_PER_TILE,
            startX = 15 * PIXELS_PER_TILE,
            startY = 15.5 * PIXELS_PER_TILE,
            leaving = true;
            direction = "up",
        ...
        },
        {
            name = "Pinky",
            color = { 1, .7, 1 },
            x = 17 * PIXELS_PER_TILE,
            y = 15.5 * PIXELS_PER_TILE,
            startX = 17 * PIXELS_PER_TILE,
            startY = 15.5 * PIXELS_PER_TILE,
            leaving = true,
            direction = "up",
        ...
        },
        {
            ...
            color = { .5, .7, 1 },
            x = 15 * PIXELS_PER_TILE,
            y = 17.5 * PIXELS_PER_TILE,
            startX = 15 * PIXELS_PER_TILE,
            startY = 17.5 * PIXELS_PER_TILE,
            leaving = true,
            direction = "up",
            scatterX = 30,
            scatterY = 33,
